document.addEventListener('DOMContentLoaded', () => {
    ...
    function enableDarkMode() {
        ...
        document.querySelector('section.texto').classList.add('dark-mode');
        document.querySelectorAll('section p').forEach(p => {
            p.classList.add('dark-mode');
        });
        document.querySelector('section.que_hacer').classList.add('dark-mode');
    ...
    function disableDarkMode() {
        ...
        document.querySelector('section.texto').classList.remove('dark-mode');
        document.querySelectorAll('section p').forEach(p => {
            p.classList.remove('dark-mode');
        });
        document.querySelector('section.que_hacer').classList.remove('dark-mode');
        document.querySelectorAll('a').forEach(a => {
